...
COPR_RPM_INSTALL_LIST_FILE=/tmp/dnf/copr_rpm_install
...
cp $GIT_COPR_RPM_INSTALL_LIST_FILE $COPR_RPM_INSTALL_LIST_FILE
...
COPR_PACKAGES_INSTALL=$(< $COPR_RPM_INSTALL_LIST_FILE)
